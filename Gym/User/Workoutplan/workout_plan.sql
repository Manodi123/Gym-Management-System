...
(2, 'Manodi123', 'harshalakshitha123456@gmail.com', '2024-06-12', 1),
(9, 'Manodi', 'test@mail.com', '2024-06-09', 7);
...
--
ALTER TABLE `workout_plan`
  ADD CONSTRAINT `fk_workout_plan_user_id` FOREIGN KEY (`user_email`) REFERENCES `users` (`email`);
COMMIT;
